  ...
  <div class="row content">
    <div class="card">
      ...
      <div class="card-action" v-if="!editMode">
        ...
        <a class="waves-effect waves-light btn-small edit" @click="editMode = !editMode">Edit</a>
        <a class="waves-effect waves-light btn-small delete" @click="deleteProfile">Delete</a>
      </div>
      <div class="card-action" v-if="editMode">
        <a class="waves-effect waves-light btn-small update" @click="updateProfile">Update</a>
